...
## Notes
- US 1.0, US 1.1, US 6.0 are too similar/redudant
- User Stories are not named properly. There are only 2 sprints. The format: " 'User Story x.y' where x is the sprint number and y is the task number"
- Team name contains non-alphanumeric characters (" ")
---
## Total Mark  
